...
public class DumpReceiver implements Receiver {
	...
	/**
	 * Ben added this. Decodes a MidiMessage to a String.
	 */
	public String messageToString(MidiMessage message) {
	...
	public String decodeMessage(ShortMessage message) {
		...
		case 0x80:
			strMessage = "note Off:" + getKeyName(message.getData1()) + ":" + message.getData2();
			break;

		case 0x90:
			strMessage = "note On:" + getKeyName(message.getData1()) + ":" + message.getData2();
			break;
